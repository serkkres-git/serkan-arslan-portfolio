      ...
      <main className="max-w-7xl mx-auto px-8 py-24">
        ...
        >
          <div className="text-center mb-24 relative z-10">
            <span className="text-[#8075ff] font-heading text-xs tracking-[0.5em] uppercase block mb-6 px-4 py-1 border border-[#8075ff] inline-block">Dynamic Visual States</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-8">
               <div className="flex-1 bg-white/5 border border-white/10 p-10 flex flex-col items-center justify-center text-center group hover:bg-[#8075ff]/5 transition-colors">
                  <Box className="text-[#8075ff] mb-4 group-hover:rotate-12 transition-transform" size={48} />
                  <h4 className="font-heading text-sm uppercase tracking-widest">Procedural Work</h4>
               </div>
               <div className="flex-1 bg-white/5 border border-white/10 p-10 flex flex-col items-center justify-center text-center group hover:bg-[#8075ff]/5 transition-colors">
                  <Move className="text-[#8075ff] mb-4 group-hover:translate-x-2 transition-transform" size={48} />
        ...
        <section className="mt-32 border-t border-white/5 pt-20">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
              <div>
                <h2 className="font-heading text-4xl font-bold mb-8 leading-tight underline decoration-[#8075ff] underline-offset-8">PHILOSOPHY</h2>
